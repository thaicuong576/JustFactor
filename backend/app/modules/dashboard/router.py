    ...
    for user in sme_users:
        ...
        data.append({
            ...
            "sme_profile": {
                ...
                "address": user.sme_profile.address if user.sme_profile else None,
                "company_website": user.sme_profile.company_website if user.sme_profile else None,
                "linkedin_url": user.sme_profile.linkedin_url if user.sme_profile else None,
                "legal_rep_name": user.sme_profile.legal_rep_name if user.sme_profile else None,
                "legal_rep_cccd": user.sme_profile.legal_rep_cccd if user.sme_profile else None,
                "business_license_path": user.sme_profile.business_license_path if user.sme_profile else None,
                "cccd_front_path": user.sme_profile.cccd_front_path if user.sme_profile else None,
                "cccd_back_path": user.sme_profile.cccd_back_path if user.sme_profile else None,
                "portrait_path": user.sme_profile.portrait_path if user.sme_profile else None,
